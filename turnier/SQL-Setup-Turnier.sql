...
CREATE TABLE IF NOT EXISTS turnier_config (
    ...
    turnier_datum_ende DATE DEFAULT NULL,
    anzahl_teams INT NOT NULL DEFAULT 32,
    anzahl_felder INT NOT NULL DEFAULT 4,
    anzahl_klassen INT NOT NULL DEFAULT 5,
    klassen_namen JSON DEFAULT '["A", "B", "C", "D", "E"]',
    spielzeit_minuten INT NOT NULL DEFAULT 0,
...
-- Schiedsrichter Teams (Referee Teams) - Must be created before turnier_spiele
